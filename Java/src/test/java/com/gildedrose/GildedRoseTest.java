...
public class GildedRoseTest {
	...
	public void agedBrieIncreasesQualityOlderItsGet() {
		GildedRose app = this.createGildedRoseItem(AGED_BRIE_ITEM, 1, 1);
	...
	public void sulfurasItemNeverAlterValues() {
		GildedRose app = this.createGildedRoseItem(SULFURAS_ITEM, 2, 80);
	...
	@Test
	public void backstagePassesItemIncreasesQualityWhenSellByDayLessThanElevenAndNeverGreaterThanFifty() {
		GildedRose app = this.createGildedRoseItem(BACKSTAGE_PASSES_ITEM, 10, 49);
	...
	@Test
	public void backstagePassesItemIncreasesQualityWhenSellByDayLessThanSixAndNeverGreaterThanFifty() {
	...
	@Test
	public void backstagePassesItemQualityNeverGreaterThanFifty() {
